...
class TestAKSCredentialLoader:
    ...
    def test_run_az_command_dry_run(self, mock_subprocess: Mock, loader: AKSCredentialLoader) -> None:
    ...
    @patch('subprocess.run')
    def test_run_az_command_success(self, mock_subprocess: Mock, prod_loader: AKSCredentialLoader) -> None:
    ...
    @patch('subprocess.run')
    def test_run_az_command_failure(self, mock_subprocess: Mock, prod_loader: AKSCredentialLoader) -> None:
    ...
    @patch('subprocess.run')
    def test_run_kubelogin_command_dry_run(self, mock_subprocess: Mock, loader: AKSCredentialLoader) -> None:
    ...
    @patch('subprocess.run')
    def test_run_kubelogin_command_success(self, mock_subprocess: Mock, prod_loader: AKSCredentialLoader) -> None:
    ...
    @patch('subprocess.run')
    def test_run_kubelogin_command_failure(self, mock_subprocess: Mock, prod_loader: AKSCredentialLoader) -> None:
    ...
    def test_get_subscriptions_with_mock(self, loader: AKSCredentialLoader, mock_subscriptions: "list[dict]") -> None:
    ...
    def test_get_subscriptions_with_filter(self, loader: AKSCredentialLoader, mock_subscriptions: "list[dict]") -> None:
    ...
    def test_get_aks_clusters_success(self, loader: AKSCredentialLoader, mock_clusters: "list[dict]") -> None:
    ...
    def test_fetch_cluster_credentials_dry_run(self, loader: AKSCredentialLoader) -> None:
        ...
        with patch.object(loader, 'run_az_command', return_value={}), \
    ...
    def test_fetch_cluster_credentials_kubelogin_failure(self, prod_loader: AKSCredentialLoader) -> None:
        ...
        with patch.object(prod_loader, 'run_az_command', return_value={}), \
             patch.object(prod_loader, 'run_kubelogin_command', return_value=False):

            result = prod_loader.fetch_cluster_credentials('test-sub-id', cluster)
            assert result is False

    def test_load_all_credentials_integration(self, loader: AKSCredentialLoader, mock_subscriptions: "list[dict]", mock_clusters: "list[dict]") -> None:
        """Test the complete credential loading workflow"""
        with patch.object(loader, 'get_subscriptions', return_value=mock_subscriptions) as mock_get_subs, \
    ...
    def test_load_all_credentials_no_clusters(self, loader: AKSCredentialLoader, mock_subscriptions: "list[dict]") -> None:
...
class TestMainFunction:
    ...
    def test_main_function_prerequisites_success(self, mock_loader_class: Mock, mock_subprocess: Mock) -> None:
